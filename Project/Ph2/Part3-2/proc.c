...
exit(void)
{
  ...
  curproc->etime=ticks;
  // end of set the end time for the current process------------------------------
...
struct proc* findNextProcess() {
    struct proc* p;
//    struct proc* result=ptable.proc;
    ...
    for(p=ptable.proc; p < &ptable.proc[NPROC]; p++)
    {
        ...
        if(p->state!=RUNNABLE)
            continue;
        if(p->priority < result->priority && p->rtime < result->rtime)
        {
            result=p;
        }
    }
    cprintf("*");
    result->priority=(result->priority)%20+1;
    return result;
}
...
//                    continue;
//
//                if(p1->priority < result->priority)
//                {
//                    if(result->priority==1)
//                    {
//                        if(p1->rtime < result->rtime)
//                        {
//                            result=p1;
//                        }
//                    }
...
//            for(p = ptable.procQueue[0][0]; p < &ptable.procQueue[0][ptable.q1Count]; p++)
//            {
//                if(p->state!=RUNNABLE)
//                    continue;
//                processToRun=p;
//                for(p1 = ptable.procQueue[0]; p1 < &ptable.procQueue[0][ptable.q1Count]; p1++)
//                {
//                    if(p1->state!=RUNNABLE)
//                        continue;
//                    if(p1->rtime < processToRun->rtime)
...
//                for(p = ptable.procQueue[1]; p < &ptable.procQueue[1][ptable.q2Count]; p++)
//                {
//                    if(p->state!=RUNNABLE)
//                        continue;
//                    processToRun=p;
//                    for(p1 = ptable.procQueue[1]; p1 < &ptable.procQueue[1][ptable.q2Count]; p1++)
//                    {
//                        if (p1->state != RUNNABLE)
//                            continue;
//                        if(p1->stime < processToRun->stime)
